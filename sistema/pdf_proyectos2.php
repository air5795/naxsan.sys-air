...
$sql_suma_bs = mysqli_query($conexion, "SELECT SUM(g_montoBs) FROM gastos_c2 where g_proyecto = '$namep' and contar = 'si'");
                            $result_sum = mysqli_fetch_array($sql_suma_bs);
                            $total = $result_sum['SUM(g_montoBs)']; 

                            $sql_suma_bs2 = mysqli_query($conexion, "SELECT SUM(montoBs) FROM ingresos_c2 WHERE proyecto = '$namep' ");
...
<table style="width:97% ;">
            ...
            <tr>
                            ...
                            <STRONG style="font-size:13px;"> REPORTE GENERAL CAJA CHICA SUCURSAL LA PAZ :  <?php echo $namep  ?>   </STRONG>
                            </td>
                        </tr>
    <tr>
        <th colspan="2" style="width:100% ; border-left-color: white; border-right-color: white; text-align:left ;" >Informe : Lic. Lucia Condori Calle</th>
    </tr>
